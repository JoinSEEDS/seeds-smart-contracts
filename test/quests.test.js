...
describe('Voted quests', async assert => {
  ...
  // //   nodes: await getProposals(),
  // //   label: 'status',
  // //   value: ['passed','rejected','passed','passed','rejected'],
  // //   given: 'applicants for a voted quest',
  // //   should: 'have proposals'
  // // })

  // // // console.log(JSON.stringify(proposals2[0].fixed.content_groups))

  // // // console.log(await getMaker(quest.fixed.hash))
  ...
  // // await checkNodes(assert, variableDetails, {
  // //   nodes: await getApplicants(quest.fixed.hash),
  // //   label: 'status',
...
describe('Voted quests timeouts', async assert => {
  ...
  // await contracts.quests.apply(firstuserQuest.fixed.hash, fourthuser, 'Applicant description', { authorization: `${fourthuser}@active` })

  // await contracts.quests.apply(seconduserQuest.fixed.hash, thirduser, 'Applicant description', { authorization: `${thirduser}@active` })
