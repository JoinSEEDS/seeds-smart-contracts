...
describe('delegate trust', async assert => {
  ...
  await contracts.proposals.delgatetrust(seconduser, firstuser, scopeCampaigns, { authorization: `${seconduser}@active` })
  await contracts.proposals.delgatetrust(thirduser, firstuser, scopeCampaigns, { authorization: `${thirduser}@active` })
  await contracts.proposals.delgatetrust(fourthuser, thirduser, scopeCampaigns, { authorization: `${fourthuser}@active` })

  console.log('delegate trust for alliances')
  const scopeAlliance = 'alliance'
  await contracts.proposals.delgatetrust(seconduser, firstuser, scopeAlliance, { authorization: `${seconduser}@active` })
  await contracts.proposals.delgatetrust(seconduser, thirduser, scopeAlliance, { authorization: `${seconduser}@active` })
  await contracts.proposals.delgatetrust(fourthuser, thirduser, scopeAlliance, { authorization: `${fourthuser}@active` })
  ...
  await contracts.proposals.cncldeltrst(fourthuser, scopeCampaigns, { authorization: `${fourthuser}@active` })
  ...
  console.log('cancel trust delegation')
  await contracts.proposals.cncldeltrst(seconduser, scopeCampaigns, { authorization: `${firstuser}@active` })
  await contracts.proposals.cncldeltrst(thirduser, scopeCampaigns, { authorization: `${firstuser}@active` })
