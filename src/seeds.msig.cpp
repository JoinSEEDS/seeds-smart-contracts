...
void msig::approve( name proposer, name proposal_name, permission_level level,
...
void msig::unapprove( name proposer, name proposal_name, permission_level level ) {
   require_auth( level );
...
void msig::cancel( name proposer, name proposal_name, name canceler ) {
...
void msig::exec( name proposer, name proposal_name, name executer ) {
...
void msig::invalidate( name account ) {
